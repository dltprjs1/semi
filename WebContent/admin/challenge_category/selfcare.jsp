...
<script type="text/javascript">
	$(function(){
		$("#10").css('color','black');
		$("#1,#3,#4,#5,#6,#7,#8,#9,#2").css('color','lightgray');
	});
</script>
...
<body>
	...
	<div id="body">
		...
		<nav>
		    ...
		    <li>
		      <a class="page-link" 
		      		href="selfcare_list.do?page=1&chall_category=C009">Previous</a>
		    </li>
		    </c:if>
		    <c:if test="${page != 1 }">
		    <li>
		      <a class="page-link" 
		      		href="selfcare_list.do?page=${page - 1 }&chall_category=C009">Previous</a>
		    </li>
		    </c:if>

				...
				<c:forEach begin="${startBlock }" end="${lastBlock }" var="i">
					...
					<c:if test="${i == page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="study_list.do?page=${i }&category_code=C008">${i }</a></li>
					</c:if>

					<c:if test="${i != page }">
						<li class="page-item"><a class="page-link"
							href="study_list.do?page=${i }&category_code=C008">${i }</a></li>
					</c:if>
				</c:forEach>

				<c:if test="${lastBlock < allPage }">
					<li class="page-item"><a class="page-link"
						href="study_list.do?page=${page + 1 }&category_code=C008">Next</a></li>
					<li class="page-item"><a class="page-link"
						href="study_list.do?page=${allPage }&category_code=C008">End</a></li>
				</c:if>
			</ul>
		</nav>
	</div>

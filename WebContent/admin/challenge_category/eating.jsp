		...
		<nav>
			<ul class="pagination">
				...
				<li><a class="page-link"
					href="eating_list.do?page=${page - 1 }&category_code=C002">Previous</a></li>
				<c:forEach begin="${startBlock }" end="${lastBlock }" var="i">

					<c:if test="${i == page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="eating_list.do?page=${i }&category_code=C002">${i }</a></li>
					</c:if>

					<c:if test="${i != page }">
						<li class="page-item"><a class="page-link"
							href="eating_list.do?page=${i }&category_code=C002">${i }</a></li>
					</c:if>
				</c:forEach>

				<c:if test="${lastBlock < allPage }">
					<li class="page-item"><a class="page-link"
						href="eating_list.do?page=${page + 1 }&category_code=C002">Next</a></li>
					<li class="page-item"><a class="page-link"
						href="eating_list.do?page=${allPage }&category_code=C002">End</a></li>
				</c:if>
			</ul>
		</nav>
	</div>

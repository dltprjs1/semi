...
<body>
	<jsp:include page="../include/chall_top.jsp" />
		<div align="center">
			...
			<input type="radio" class="btn-check" name="options-outlined" id="open-outlined" autocomplete="off" value="open">
			...
			<input type="radio" class="btn-check" name="options-outlined" id="private-outlined" value="private" autocomplete="off">
			<label class="btn btn-outline-danger" for="private-outlined"><b>비공개 챌린지🔒</b>
			<br>친구들끼리 모여 프라이빗하게 챌린지
			<br>(초대받은 사람만 참여할 수 있어요)</label>
			
			<br><br><br>
			<button type="button" class="btn btn-dark" onclick="location.href='<%=request.getContextPath()%>/member_challJoin3.do'">다음</button>
